    ...
    @extends('layouts.app', ['title' => __('Crear Pregunta')])
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <h3 class="mb-0">{{ __('Crear preguntas') }}</h3>
                        </div>
                    </div>
                    <div class="card-body">
                        <form method="post" action="{{ route('crear_pregunta.create') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('name') ? ' has-danger' : '' }}">
                                    <label class="form-control-label" for="input-name" uppercase>{{ __('Pregunta') }}</label>
                                ...
                                <div class="form-group">
                                    <label class="form-control-label"">{{ __('Tipo') }}</label>
